...
# Final Submission:
# https://cdn.upgrad.com/uploads/production/7aee9703-8361-43df-b652-ae0b96a5aab4/MunirathinamDuraisamy_LendingClubCaseStudy.txt
# 
# 
# Procedure:<br>
#     1. Import Required Libraries<br>
#     2. Data Overview - (39717 * 111)<br>
#     3. Data Cleaning<br>
#         a. Overview:<br>
#             i. Missing Data Treatment (done)<br>
#             ii. Standardizing Values (done)<br>
#             iii. Remove Irrelevant Variables both w.r.t. business and data (done)<br>
#             iv. Outliers Analysis and Treatments (done)<br>
#             v. Derived Metrics & Binning<br>
# <br>
#         b. Details:
#                (UVA)
#                 . Continuous:
